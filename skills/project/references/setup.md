...
1. **Create a task:** Use `task new` to create the first task
2. **Explore features:** Use `feature list` to see existing feature specs
3. **Check status:** Use `task list` to view the task board
