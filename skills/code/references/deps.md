...
- For the reverse — finding what code references a spec — use [`feature refs`](../../feature/references/refs.md).
- For spec-to-spec dependencies — use [`feature deps`](../../feature/references/deps.md).
