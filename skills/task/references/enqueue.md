...
|-------------|----------|----------------------------|
| [`--project`](../../spec/features/cli/_args/project.md) | Yes      | Project identifier         |
| [`--task`](../../spec/features/cli/task/_args/task.md)    | Yes      | Task identifier to enqueue |
