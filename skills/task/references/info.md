...
| [`--task`](../../spec/features/cli/task/_args/task.md) | Yes | Task path using `/` as separator (e.g., `implement-cli/parse-arguments`) |
| [`--format`](../../spec/features/cli/task/_args/format.md) | No | Output format: `text` (default), `json`, `yaml` |
