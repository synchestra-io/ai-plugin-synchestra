---
name: whats-next
description: Generates or updates the WHATS-NEXT.md prioritization report for plans. Use when a plan or task is completed, or when the user asks "what should we work on next?"
user-invocable: true
---
