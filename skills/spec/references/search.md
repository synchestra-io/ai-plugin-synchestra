...
- For validating spec structure (rather than searching content), use [`spec lint`](lint.md).
- For navigating the feature hierarchy, use [`feature tree`](../../feature/references/tree.md) or [`feature info`](../../feature/references/info.md).
